...
public class Scores {
    ...
    public static int nounScore;
    public static int adjScore;
    public static int advScore;
    public static int idiomScore;

    public static int elementsAdded;

    // points added
    //public static int pointsAdded;
    public static int verbPointsAdded;
    public static int sentencePointsAdded;
    public static int phrasalPointsAdded;
    public static int nounPointsAdded;
    public static int adjPointsAdded;
    public static int advPointsAdded;
    public static int idiomPointsAdded;
    // points added video
    //public static int pointsAddedVideo;
    ...
    public static int nounPointsAddedVideo;
    ...
    public static int nounAdded;
    public static int adjAdded;
    ...
    public static int nounAddedVideo;
    ...
    public static int nounQuizCompleted;
    public static int adjQuizCompleted;
    public static int advQuizCompleted;
    public static int idiomQuizCompleted;

    // quiz Counter Completed
    public static int verbQuizCounterCompletedCorrectly;
