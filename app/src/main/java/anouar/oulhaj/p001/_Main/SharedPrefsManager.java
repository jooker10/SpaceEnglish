...
public class SharedPrefsManager {
    ...
    public void getSharedPreferencesData() {
        ...
        Scores.verbQuizCounterCompletedCorrectly = sharedPreferences.getInt(Constants.TAG_VERB_QUIZ_COMPLETED_CORRECTLY,0);
    ...
    public void putSharedPreferencesScores(SharedPreferences.Editor editor) {
        ...
        editor.putInt(Constants.TAG_VERB_QUIZ_COMPLETED_CORRECTLY, Scores.verbQuizCounterCompletedCorrectly);
