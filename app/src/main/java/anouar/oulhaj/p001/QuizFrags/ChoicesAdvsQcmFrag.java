...
public class ChoicesAdvsQcmFrag extends Fragment {
    ...
    private List<Adverb> allAdverbs = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_choices_advs, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tv_qst = view.findViewById(R.id.the_question_of_adv);
        tv_score = view.findViewById(R.id.quiz_tv_score_advs);
        tv_qstCount = view.findViewById(R.id.quiz_tv_advs_qstNumber);
        tv_ofTheVerb = view.findViewById(R.id.quiz_Theadv_qst);
        tv_notes = view.findViewById(R.id.choicesFrag_tv_notes_advs);

        btn_confirmNext = view.findViewById(R.id.quizFrag_Btn_confirm_next_advs);

        radioGroup_choices = view.findViewById(R.id.choices_radioGroup_advs);
        rb0 = view.findViewById(R.id.choicesFrag_advs_option0);
        rb1 = view.findViewById(R.id.choicesFrag_advs_option1);
        rb2 = view.findViewById(R.id.choicesFrag_advs_option2);


        rb_defaultColor_txt = rb1.getTextColors();
        //------- fill Lists--------------
        allAdverbs = Utils.advsList;
 ...
 /*       DbAccess db = DbAccess.getInstance(getActivity());
    ...
    private void showNextQst() {
        ...
        if (qst_counter < qstCounterTotal) {
            ...
            //----set tv_theVerbFR--------
            tv_ofTheVerb.setText(allAdverbs.get(qst_counter).getAdv_fr());
    ...
    private void SetRandomInts(){
        for (int i = 0; i < allAdverbs.size(); i++) {
            List<Integer> randomInts = new ArrayList<>();
            Random random = new Random();

            while(randomInts.size() != 2) {
                int j = random.nextInt(allAdverbs.size());
            ...
            String rb0_str = allAdverbs.get(randomInts.get(0)).getAdv_eng();
            String rb1_str = allAdverbs.get(randomInts.get(1)).getAdv_eng();
            String rb2_str = allAdverbs.get(randomInts.get(2)).getAdv_eng();
            String right_Answer = allAdverbs.get(i).getAdv_eng();
