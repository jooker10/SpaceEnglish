 ...
 * @param fragmentList List of fragments to be displayed in ViewPager2.
 */(
    ...
    override fun createFragment(position: Int): Fragment {
        return fragmentList[position] // Return fragment at specified position
    }
    ...
    override fun getItemCount(): Int {
        return fragmentList.size // Return total number of fragments
    }
}
