...
class AppSettingsFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        themeSwitchPref = findPreference(Constants.SETTINGS_KEY_THEME_SWITCH) ?: return
        val privacyPolicyPref = findPreference<Preference>(Constants.SETTINGS_KEY_PRIVACY_BUTTON)
        val contactSupportPref = findPreference<Preference>(Constants.SETTINGS_KEY_CONTACT_US)
        val languagePref = findPreference<ListPreference>(Constants.SETTINGS_KEY_LANGUAGE_SWITCH)
        ...
        languagePref?.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { x, newValue ->
               ...
               /* QuizUtils.nativeLanguage = when (newLang) {
                ...
                QuizUtils.translationLanguage = newValue.toString()
        ...
        themeSwitchPref.isChecked = QuizUtils.isDarkThemeEnabled
        themeSwitchPref.onPreferenceClickListener =
            Preference.OnPreferenceClickListener {
                QuizUtils.isDarkThemeEnabled = themeSwitchPref.isChecked
                settingsActionListener?.onThemeToggled(QuizUtils.isDarkThemeEnabled)
                true
            }
    ...
    private fun launchSupportEmailIntent() {
        ...
        val subject = getString(R.string.settings_email_enter_the_subject)
        val msg = getString(R.string.settings_email_enter_your_question_please)
        ...
        if (intent.resolveActivity(requireActivity().packageManager) != null) {
            startActivity(Intent.createChooser(intent,
                getString(R.string.settings_email_choose_email_app)))
        } else {
            Toast.makeText(requireActivity(),
                getString(R.string.settings_email_no_email_app_installed), Toast.LENGTH_SHORT).show()
        }
    }
